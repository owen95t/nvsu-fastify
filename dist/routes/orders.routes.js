...
const orderRouter = async (fastify) => {
    ...
    fastify.route({
        ...
        url: '/',
        schema: {
            body: orders_interface_1.CreateOrderSchema,
        },
        preHandler: [auth_service_1.verifyJwt],
